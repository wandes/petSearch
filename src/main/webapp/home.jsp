...
<html>
    ...
    <%if (request.getParameter("registerPublication") != null) {
           ...
           Animal animal =  Animal.getAnimal(user.getId());
            try {
                Address.insertAddress(request.getParameter("street"), Integer.parseInt(request.getParameter("postalCode")), request.getParameter("district"), request.getParameter("city"), request.getParameter("state"), request.getParameter("country"),animal.getIdAnimal(),user.getId());
               }
             catch (Exception ex) {
                 System.out.println(ex.getMessage());
                 msg = ex.getMessage();
	...
	String dataCompleta = String.valueOf(diaAtual) + "/" + String.valueOf(mesAtual) + "/" + String.valueOf(anoAtual);
           
        Animal animal = Animal.getAnimal(user.getId()); 
          Address ad = Address.getAddress(animal.getIdAnimal());
        
         Publication.insertPublication(Integer.parseInt( request.getParameter("statusAnimal")) ,dataCompleta , user.getId() ,ad.getIdAddress(), animal.getIdAnimal());
